...
- [ ] 接入真实上市公司公开数据（Phase 3：8 家 40 份 PDF 已收集，`data/derived/manifest.csv` 来源清单已生成；**宁德时代、隆基绿能 2021-2025 已完成 5 年结构化摘录**（隆基 2024 使用修订版、2025 商誉原表为空），其余 6 家待扩展；真实样本评测管线 `eval/run_real_eval.py` 仅完成骨架，不出 D4/D5 主结论。详见 [docs/real_data_sources.md](docs/real_data_sources.md) §7）
